                                ...
                                <div class="card mb-4">
                                    ...
                                    <div class="card-body">
                                        <form action="../backend/loaisp-xuly.php" method="post">
                                            ...
                                            <div class="row mb-3">
                                                <label class="col-sm-2 col-form-label" for="origi">Xuất xứ của thương hiệu</label>
                                                <div class="col-sm-10">
                                                    <div class="input-group input-group-merge">
                                                        <span id="loaisp" class="input-group-text"><i class='bx bxs-plane-alt'></i></span>
                                                        <input type="text" class="form-control" id="origi"  placeholder="Xuất xứ thương hiệu" value=""
                                                            name="origi" />
                                                    </div>
                                                </div>
                                            </div>
